...
const filename=path.resolve('prisma',url.slice(5));await mkdir(path.dirname(filename),{recursive:true});const file=await open(filename,'a',0o600);await file.close();
